...
<h3 class="header2">To make an appointment with a doctor, <a href="${pageContext.request.contextPath}save">register</a> first on our website and sign in. If you are
